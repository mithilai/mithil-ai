...
import { useFormStatus } from 'react-dom'; // ✅ correct
...
//   const [state, formAction] = useActionState(submitContactForm, initialState); // ✅ updated
      ...
      <div className="container mx-auto px-4">
        ...
        <Card className="max-w-2xl mx-auto shadow-xl">
          ...
          <CardContent>
            <form
              ref={formRef}
              action="https://formsubmit.co/mithilm21@gmail.com"
              method="POST"
              className="space-y-6"
            >
